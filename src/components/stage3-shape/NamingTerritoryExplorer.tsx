    ...
    <div className="space-y-5">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 text-xs text-slate-400 bg-white/5 px-3 py-1.5 rounded-lg border border-white/10">
          ...
          Selected: <span className="text-white font-semibold ml-1">{selected}</span>
        </div>
      </div>
          ...
          return (
            <div
              ...
              className={`p-5 rounded-2xl border cursor-pointer transition-all duration-200 relative overflow-hidden group ${
                isSelected
                  ? "bg-gradient-to-br from-purple-500/15 via-[#0e1015] to-[#090a0f] border-purple-500/40 shadow-lg shadow-purple-500/10"
